...
export default function UserBlogPostPage(){
  ...
  useEffect(()=>{ axios.get(`http://localhost:5000/api/posts/user/${userId}/${slug}`).then(r=>setPost(r.data)); },[userId,slug]);
  ...
  return (
    <div className="container my-5">
      ...
      <div className="mt-4" dangerouslySetInnerHTML={{__html: post.content_html || post.content || ''}} />
    </div>
  );
}
